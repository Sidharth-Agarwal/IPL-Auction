...
export const auctionSettings = {
  defaultWalletAmount: parseInt(process.env.REACT_APP_DEFAULT_WALLET_AMOUNT || 10000),
  minBidIncrement: parseInt(process.env.REACT_APP_MIN_BID_INCREMENT || 100),
  unsoldPriceReduction: parseFloat(process.env.REACT_APP_UNSOLD_PRICE_REDUCTION || 0.5)
};
